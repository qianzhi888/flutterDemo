...
import 'package:flutter_app_demo/home/common/bottom_dialog.dart';
        ...
        child: Container(
          child: Column(
            ...
            children: <Widget>[
                      ...
                      Align(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Image.asset("images/ic_right_back.png"),
                          ],
                        ),
                      ),
                    ],
              ...
              InkWell(
                onTap: () {
                  BottomDialog.showBasicModalBottomSheet(context, listIf,
                      pressed: (str) {
                    setState(() {
                      canSelfOrder = str;
                    });
